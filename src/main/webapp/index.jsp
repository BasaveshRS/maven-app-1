...
<body>
    <div class="container">
        <div class="content">
            ...
            <p>My name is <span class="highlighted-name">Basavesh</span>, I am an <span class="trainer">AWS and DevOps Trainer</span>.</p>
            ...
            <p><strong>DevOps Concepts:</strong>  Introduction to DevOps, SDLC - Concept & Models, Maven, Git, GitHub, Tomcat, Jenkins, Docker, Kubernetes, Terraform, Ansible, SonarQube</p>
            <p>
                ...
                <a href="https://www.linkedin.com/in/basavesh-r-s-4b1523321/" target="_blank">
                    <button class="linkedin-button"><i class="fab fa-linkedin"></i> Basavesh R S - LinkedIn</button>
                </a>
            </p>
        </div>
    </div>
    ...
    <div class="copyright">
        <span class="icon">&copy;</span> Basavesh
    </div>
</body>
</html>
